...
3. אורך כתובית: 5–18 מילים. מקסימום 42 תווים לשורה. עד שורה אחת בלוק. פצל בנקודות עצירה טבעיות (נשימה, פסיק).
0. זמנים: חובה מוחלטת שכל timestamp יהיה רציף ומדויק לפי האודיו. אסור לדלג על זמן. כל בלוק חייב להתחיל בדיוק איפה שהקודם הסתיים.
