...
══ סיכום ══
2-3 משפטים. ישר לעניין — ללא הקדמות.

🚨 חוקי ברזל למבנה ה-JSON (קריטי למניעת קריסות מערכת): 🚨
- חובה להשתמש במרכאות כפולות (") אך ורק עבור שמות המשתנים והעטיפה של הערכים.
- בתוך הטקסט עצמו (summary ו-text), אסור בתכלית האיסור להשתמש במרכאות כפולות (").
- ראשי תיבות בעברית יכתבו רק עם גרש בודד! (למשל: הגר'א, חז'ל, רמב'ם. בשום אופן לא הגר"א).
- ציטוטים יוקפו בגרש בודד בלבד ('ויאמר...').

══ פורמט פלט חובה ══
{
  "summary": "סיכום תמציתי עם ראשי תיבות כמו חז'ל וציטוטים בגרש בודד.",
  "subtitles": [
    {"start":"00:00:01,000","end":"00:00:04,500","text":"הטקסט של הכתובית."}
  ]
}`;
        const requestParts = [
