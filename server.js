...
==============================
כללי חלוקה וסנכרון זמנים (קריטי לנגן!)
==============================
- חותמות הזמן חייבות להיות מדויקות ב-100% לדיבור הנשמע באודיו. אסור "להמציא" או "להעריך" זמנים.
- כמות מילים מקסימלית לבלוק: 10 עד 15 מילים לכל היותר! (אל תדחס טקסט).
- פיצול בלוקים יתבצע אך ורק לפי:
  1. עצירות טבעיות של הדובר (לקיחת אוויר, פסיק, נקודה).
  2. הגעה למקסימום המילים (10-15).
- רצף: הזמן שבו מסתיים בלוק אחד, יהיה קרוב מאוד לזמן שבו מתחיל הבלוק הבא, אך ללא חפיפה (לדוגמה: 00:00:05,000 מסתיים, הבא מתחיל ב-00:00:05,100).
